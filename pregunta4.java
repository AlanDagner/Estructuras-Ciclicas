...
public class pregunta4 {
	...
	public static void main(String args[]) throws IOException {
		...
		double i;
		double monto_global;
		double monto_ventas_de_0_a_10000;
		double monto_ventas_de_10000_a_20000;
		double n;
		double venta;
		double ventas_de_0_a_10000;
		double ventas_de_10000_a_20000;
		...
		for (i=1;i<=n;i++) {
			...
			System.out.print("Ingrese precio de la venta:");
